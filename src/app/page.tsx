  ...
  return (
    <div className="min-h-screen font-inter">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card max-w-2xl mx-auto text-center p-6 sm:p-8 relative z-10">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-poppins font-bold text-green-800 mb-4">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <section id="plantas" className="mb-16">
          <div className="glass-card p-6 sm:p-8 mb-8">
            <h2 className="text-2xl sm:text-3xl font-poppins font-bold text-green-800 mb-4 text-center">
              Plantas Disponibles
            </h2>
            <p className="text-green-700 text-center max-w-2xl mx-auto text-sm sm:text-base">
          ...
          {plants.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
              {plants.map((p) => (
                <div key={p.id} className="glass-card p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-center">
                    <h3 className="text-lg sm:text-xl font-poppins font-semibold text-green-800 mb-1">
                      {p.commonName}
                    </h3>
                    {p.scientificName && (
                      <p className="text-xs sm:text-sm text-green-600 italic mb-3 sm:mb-4">
                        {p.scientificName}
                      </p>
                    )}
                    <a
      ...
      {/* Footer */}
      <footer className="glass-card mx-4 mb-4 p-4 sm:p-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="text-xl sm:text-2xl">🌱</span>
              <span className="font-poppins font-semibold text-green-800 text-sm sm:text-base text-center md:text-left">
                Vivero Municipal de Bagua
              </span>
            </div>
            <div className="flex items-center gap-4 sm:gap-6 text-green-700 text-sm sm:text-base">
